...
- [ ] Explain what a token is used for.
  ...
  Used to authenticate if a user has logged in already and can access certain content.

- [ ] What steps can you take in your web apps to keep your data secure?

  Private Routes and Token storage. OAuth. 2 Factor-Authentication.

- [ ] Describe how web servers work.

  Web servers receive HTTP requests from clients or other servers and respond with data. Communicate and export and import data back and forth. 
